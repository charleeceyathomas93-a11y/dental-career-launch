...
import type { ContactResponse, ContactSubmission, ErrorResponse, HealthStatus } from "./api.schemas";
...
export declare const submitContact: (contactSubmission: ContactSubmission, options?: RequestInit) => Promise<ContactResponse>;
